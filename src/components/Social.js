				...
				<div className="container container--red">
					<div id="social" className="social">
						...
						<div className="social__icons-container">
							<a
								href="https://www.instagram.com/dilutedband/"
								target="_blank"
								onClick={this.navigationEvent.bind(this, 'Instagram')}
							>
							...
							<a
								href="https://www.facebook.com/DilutedBand"
								target="_blank"
								onClick={this.navigationEvent.bind(this, 'Facebook')}
							>
								<div className="social__icons-container__icon">
							...
							<a
								href="https://twitter.com/dilutedband"
								target="_blank"
								onClick={this.navigationEvent.bind(this, 'Twitter')}
							>
								<div className="social__icons-container__icon">
							...
							<a
								href="https://soundcloud.com/dilutedband"
								target="_blank"
								onClick={this.navigationEvent.bind(this, 'Soundcloud')}
							>
								<div className="social__icons-container__icon">
